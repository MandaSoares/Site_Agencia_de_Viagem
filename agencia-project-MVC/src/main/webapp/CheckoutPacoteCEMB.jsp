		...
		<div class="details shadow">
			<div class="details__item">
				...
				<div class="item__details">
					<div class="item__title">Pacote: Croácia, Eslovênia,
						Montenegro e Bósnia-Herzegovina - 15 dias</div>
						...
						<div class="details__user">
							<div class="row">
								<div class="field">
									...
									<input type="text" class="input txt text-validated" placeholder="Insira seu número aqui" name="telefone" />
								</div>
							</div>
							<div class="row">
