...
public class RotasDAO {
	...
	public Rotas get(int id) throws SQLException {
		...
		if (result.next()) {
			Rotas rotas = new Rotas(result.getString(2), result.getInt(3), result.getString(4), result.getString(5),
					result.getDouble(6), result.getString(7), result.getString(8), result.getString(9));
