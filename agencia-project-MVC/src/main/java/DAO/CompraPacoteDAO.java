...
public class CompraPacoteDAO {
	...
	public CompraPacote get(int id) throws SQLException {
		...
		if (result.next()) {
			...
			Cliente cliente = new Cliente(result.getString(9), result.getString(10), result.getString(11),
					result.getString(12), result.getString(13), result.getString(14));
			Pacote pacote = new Pacote(result.getInt(16), result.getString(17), result.getString(18),
					result.getString(19), result.getString(20), result.getString(21), result.getDouble(22),
					result.getString(23), result.getString(24), result.getString(25));

			CompraPacote compraPacote = new CompraPacote(cliente, pacote, result.getString(4), result.getDouble(5),
